...
#VIN.load_state_dict(torch.load("vin_8x8.pth",map_location='cpu'))
print(VIN)
    ...
    #   print(i)		
     ...
     #   print("loss",loss/100)
        ...
        if count%update_freq==0:
            #VIN.load_state_dict(oldVIN.state_dict())
            oldVIN.load_state_dict(VIN.state_dict())
            print("update")
...
#evaluate(grid,vinPolicy)
    ...
    if k%500==0:  
        ...
        if k is not 0:
            ...
            print(evaluate(grid,vinPolicy,iters=200))
        torch.save(VIN.state_dict(),"model/moving-model-vin-"+str(k)+".pkl") 
